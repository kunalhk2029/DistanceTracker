...
import com.example.distancetracker.Permission.Permission.Request_Permission
import com.example.distancetracker.Permission.Permission.checkLocationPermission
...
class PermissionFragment : Fragment(),EasyPermissions.PermissionCallbacks {
    ...
    override fun onCreateView(
        ...
        {
            findNavController().navigate(R.id.action_permissionFragment_to_maps_Fragment)
        }
